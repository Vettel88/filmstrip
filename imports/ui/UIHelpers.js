...
export const checkMandatory = (field, params) => !field ? showAndThrowError(t('Validation.mandatory', params)) : null
export const checkEmail = (email, params) => !validateEmail(email) ? showAndThrowError(t('Validation.email', params)) : null
